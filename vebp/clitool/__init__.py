...
from vebp.clitool.command import Command
from vebp.clitool.exit import cmd_exit
from vebp.clitool.help import cmd_help
from vebp.libs.args import parse_args
...
class CliTool:
    ...
    def __init__(self, name: str = "clitool", version: str = "1.0.0", description: str = None, epilog: str = None):
        ...
        self.subcommands: Dict[str, "CliTool"] = {}  # 存储子命令
    ...
    def _add_default(self):
        ...
        self.add_cmd_command("exit", cmd_exit)
    ...
    def add_argument(self, name: str, flag=None, action: Literal["append", "store_true"] = None, _help=None, default=None, *_args, **_kwargs):
        """
        添加arg
    ...
    def add_sub_argument(self, _id: str, name: str, flag=None, action: Literal["append", "store_true"] = None, _help=None, default=None, *_args, **_kwargs):
        """
        添加子命令的arg
        :param _id: 子命令名称
        :param name: arg的名称。为直接名称或--名称(如果添加了子命令，那么不能使用直接名称)
