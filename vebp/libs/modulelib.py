...
class ModuleLoader:
    def __init__(self, package_path: Union[Path, str], package_name: str, main_module_name: str, func_name: Optional[str] = None, app_func_replacements: Optional[Dict[str, Callable]] = None, func_replacements: Optional[Dict[str, Callable]] = None, class_replacements: Optional[dict] = None) -> None:
        self.package_path = package_path
        self.package_name = package_name
        self.main_module_name = main_module_name
        self.func_name = func_name or "func"
        self.app_func_replacements = app_func_replacements or {}
    ...
    def __enter__(self):
        ...
        with FunctionInjection(self.package_path, self.package_name, self.func_name, {**self.app_func_replacements, **self.class_replacements, **self.func_replacements}) as module:
